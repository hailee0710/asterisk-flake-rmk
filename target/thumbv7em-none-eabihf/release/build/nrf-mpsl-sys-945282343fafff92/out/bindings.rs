...
pub const MPSL_TIMESLOT_CONTEXT_SIZE: u32 = 96;
...
pub const MPSL_CX_REQ_TRIG_INSTANT: MPSL_CX_REQ_TRIG = 0;
#[doc = "Applicable values to mpsl_cx_req_trig_t type."]
pub type MPSL_CX_REQ_TRIG = ::core::ffi::c_uint;
#[doc = "Type for coexistence request signal triggers.\n\n Applicable values are defined in MPSL_CX_REQ_TRIG."]
pub type mpsl_cx_req_trig_t = u8;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of mpsl_cx_request_t"][::core::mem::size_of::<mpsl_cx_request_t>() - 3usize];
    ["Alignment of mpsl_cx_request_t"][::core::mem::align_of::<mpsl_cx_request_t>() - 1usize];
    ...
    ["Offset of field: mpsl_cx_request_t::trigger"][::core::mem::offset_of!(mpsl_cx_request_t, trigger) - 2usize];
};
...
pub const MPSL_PM_EVENT_STATE_BEFORE_EVENT: MPSL_PM_EVENT_STATE = 0;
pub const MPSL_PM_EVENT_STATE_NO_EVENTS_LEFT: MPSL_PM_EVENT_STATE = 1;
#[doc = "Applicable values for mpsl_pm_event_state_t type."]
pub type MPSL_PM_EVENT_STATE = ::core::ffi::c_uint;
#[doc = "MPSL Power Management state in regards to next event.\n\n Applicable values are defined in MPSL_PM_EVENT_STATE."]
pub type mpsl_pm_event_state_t = u8;
...
const _: () = {
    ...
    ["Offset of field: mpsl_pm_params_t::cnt_flag"][::core::mem::offset_of!(mpsl_pm_params_t, cnt_flag) - 9usize];
};
unsafe extern "C" {
...
pub const MPSL_PM_LOW_LATENCY_STATE_OFF: MPSL_PM_LOW_LATENCY_STATE = 0;
pub const MPSL_PM_LOW_LATENCY_STATE_REQUESTING: MPSL_PM_LOW_LATENCY_STATE = 1;
pub const MPSL_PM_LOW_LATENCY_STATE_ON: MPSL_PM_LOW_LATENCY_STATE = 2;
pub const MPSL_PM_LOW_LATENCY_STATE_RELEASING: MPSL_PM_LOW_LATENCY_STATE = 3;
#[doc = "Applicable values for mpsl_pm_low_latency_state_t type."]
pub type MPSL_PM_LOW_LATENCY_STATE = ::core::ffi::c_uint;
...
pub type mpsl_pm_low_latency_state_t = u8;
unsafe extern "C" {
...
pub const MPSL_PHY_BLE_1M: MPSL_PHY = 0;
pub const MPSL_PHY_BLE_2M: MPSL_PHY = 1;
pub const MPSL_PHY_BLE_LR125Kbit: MPSL_PHY = 2;
pub const MPSL_PHY_BLE_LR500Kbit: MPSL_PHY = 3;
pub const MPSL_PHY_Ieee802154_250Kbit: MPSL_PHY = 4;
pub const MPSL_PHY_NRF_1Mbit: MPSL_PHY = 5;
pub const MPSL_PHY_NRF_2Mbit: MPSL_PHY = 6;
pub const MPSL_PHY_NRF_250Kbit: MPSL_PHY = 7;
pub const MPSL_PHY_NRF_4Mbit0_5: MPSL_PHY = 8;
pub const MPSL_PHY_NRF_4Mbit0_25: MPSL_PHY = 9;
pub const MPSL_PHY_NRF_4Mbit_0BT6: MPSL_PHY = 10;
pub const MPSL_PHY_NRF_4Mbit_0BT4: MPSL_PHY = 11;
#[doc = "Applicable values for mpsl_phy_t type."]
pub type MPSL_PHY = ::core::ffi::c_uint;
#[doc = "PHY type.\n\n Applicable values are defined in MPSL_PHY."]
pub type mpsl_phy_t = u8;
#[doc = "TX power, dBm."]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of mpsl_tx_power_envelope_t"][::core::mem::size_of::<mpsl_tx_power_envelope_t>() - 41usize];
    ["Alignment of mpsl_tx_power_envelope_t"][::core::mem::align_of::<mpsl_tx_power_envelope_t>() - 1usize];
    ...
    ["Offset of field: mpsl_tx_power_envelope_t::envelope"]
        [::core::mem::offset_of!(mpsl_tx_power_envelope_t, envelope) - 1usize];
};
unsafe extern "C" {
